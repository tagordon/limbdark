...
function cel_bulirsch(k2,p,a,b)
@assert (k2 <= 1)
ca = sqrt(eps(k2))
...
function cel_bulirsch(k2,kc,p,a,b)
@assert (k2 <= 1)
ca = sqrt(eps(k2))
# Avoid undefined k2=1 case:
if k2 == 1.0 || kc == 0.0
...
function cel_bulirsch(k2,kc,p,a1,a2,a3,b1,b2,b3)
...
function cel_bulirsch_nodiv(k2,kc,p,a1,a2,a3,b1,b2,b3)
# This assumes first value of a and b uses p; the rest have p=1.
@assert (k2 <= 1)
ca = sqrt(eps(k2))
# Avoid undefined k2=1 case:
